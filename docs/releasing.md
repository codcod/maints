...
The project uses GitHub Actions to automate the release process. A workflow is
triggered whenever a tag starting with `v` is pushed to the repository.
...
2.  **Wait for the build**:
    ...
    start. It performs the following steps:
...
3.  **Review and Publish**:
    ...
    -   Go to the [Releases page](https://github.com/codcod/maints/releases).
